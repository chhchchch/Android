...
public class view_information extends AppCompatActivity implements CardStackView.ItemExpendListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStackView.setItemExpendListener(view_information.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_up_down_stack:
                ...
                break;
            case R.id.map:
                Intent intent = new Intent(view_information.this,Navigation.class);
