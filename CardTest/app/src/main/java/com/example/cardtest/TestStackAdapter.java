...
import androidx.core.content.ContextCompat;//改成这个
...
public class TestStackAdapter extends StackAdapter<Integer> {
    ...
    protected CardStackView.ViewHolder onCreateView(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            default:
                ...
                Data.viewHolder[Data.n]=  new ColorItemViewHolder(view);
                return Data.viewHolder[Data.n++];
        }
    }
    ...
    static class ColorItemViewHolder extends CardStackView.ViewHolder {
        ...
        public void onBind(Integer data, int position) {//添加内容
            mLayout.getBackground().setColorFilter(ContextCompat.getColor(getContext(), data), PorterDuff.Mode.SRC_IN);
            mTextTitle.setText(Data.Nodes[position]);
            passage.setText(Data.info[position]);
        }
